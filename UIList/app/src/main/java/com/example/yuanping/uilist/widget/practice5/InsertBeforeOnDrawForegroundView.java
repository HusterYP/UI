 ...
 * @description:
 */
public class InsertBeforeOnDrawForegroundView extends AppCompatImageView {

    private Paint mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    private RectF mRectF = new RectF();
    private BitmapDrawable mBitmapDrawable;

    public InsertBeforeOnDrawForegroundView(Context context) {
        super(context);
    }

    public InsertBeforeOnDrawForegroundView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public InsertBeforeOnDrawForegroundView(Context context, AttributeSet attrs, int defStyleAttr) {
