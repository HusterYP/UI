 ...
 * @description:
 */
public class CameraRotateXY extends View {

    private Camera mCamera = new Camera();

    public CameraRotateXY(Context context) {
        super(context);
    }

    public CameraRotateXY(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public CameraRotateXY(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public CameraRotateXY(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int
            defStyleRes) {
