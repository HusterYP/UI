...
public class MatrixRotateView extends View {
    ...
    public MatrixRotateView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int
            defStyleRes) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        matrix1.postRotate(180, leftWidth + bitmap.getWidth() / 2, height + bitmap
                .getHeight() / 2);
        ...
        matrix2.postRotate(45, rightWidth + bitmap.getWidth() / 2, height + bitmap
                .getHeight() / 2);
