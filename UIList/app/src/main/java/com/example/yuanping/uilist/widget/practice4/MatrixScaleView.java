...
public class MatrixScaleView extends View {
    ...
    public MatrixScaleView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int
            defStyleRes) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        matrix1.postScale(1.5f, 1.5f, leftWidth + bitmap.getWidth() / 2, height + bitmap
                .getHeight() / 2);
        ...
        matrix2.postScale(0.5f, 1.5f, rightWidth + bitmap.getWidth() / 2, height + bitmap
                .getHeight() / 2);
